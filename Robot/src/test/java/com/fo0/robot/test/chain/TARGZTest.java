...
public class TARGZTest {
	...
	private static final ArchiveFormat TYPE = ArchiveFormat.TAR;
	...
	private static String ARCHIVE_NAME = "test.tar.gz";
	...
	public void compress() {
		try {
			Archiver zipArchive = ArchiverFactory.createArchiver(TYPE, CompressionType.GZIP);
